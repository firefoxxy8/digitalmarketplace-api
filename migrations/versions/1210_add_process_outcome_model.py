...
def upgrade():
    ...
    op.create_table('process_outcomes',
        ...
        sa.CheckConstraint(
            ...
            name=op.f('ck_process_outcomes_brief_keys_nullable'),
        ),
        sa.CheckConstraint(
            ...
            name=op.f('ck_process_outcomes_direct_award_keys_nullable'),
        ),
        sa.CheckConstraint(
            'CAST(direct_award_project_id IS NULL AS BOOLEAN) != CAST(brief_id IS NULL AS BOOLEAN)', name=op.f('ck_process_outcomes_either_brief_xor_direct_award'),
        ),
        sa.ForeignKeyConstraint(['brief_id'], ['briefs.id'], name=op.f('process_outcomes_brief_id_fkey')),
        ...
        sa.ForeignKeyConstraint(
            ['brief_response_id'],
            ['brief_responses.id'],
            name=op.f('process_outcomes_brief_response_id_fkey'),
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f('process_outcomes_direct_award_archived_service_id_fkey'),
        ),
        sa.ForeignKeyConstraint(
            ['direct_award_project_id'],
            ['direct_award_projects.id'],
            name=op.f('process_outcomes_direct_award_project_id_fkey'),
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f('process_outcomes_direct_award_search_id_fkey'),
        ),
        sa.PrimaryKeyConstraint('id', name=op.f('process_outcomes_pkey')),
        sa.UniqueConstraint('external_id', name=op.f('uq_process_outcomes_external_id')),
    )
    op.create_index(
...
def downgrade():
    op.drop_index('idx_process_outcomes_completed_direct_award_project_unique', table_name='process_outcomes')
    op.drop_index('idx_process_outcomes_completed_brief_unique', table_name='process_outcomes')
